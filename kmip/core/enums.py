...
class KeyFormatType(enum.Enum):
    ...
    TRANSPARENT_ECDSA_PRIVATE_KEY = (
        0x0000000E  # Deprecated in KMIP 1.4, designated '(Reserved)' in KMIP 2.0
    )
    TRANSPARENT_ECDSA_PUBLIC_KEY = (
        0x0000000F  # Deprecated in KMIP 1.4, designated '(Reserved)' in KMIP 2.0
    )
    TRANSPARENT_ECDH_PRIVATE_KEY = (
        0x00000010  # Deprecated in KMIP 1.4, designated '(Reserved)' in KMIP 2.0
    )
    TRANSPARENT_ECDH_PUBLIC_KEY = (
        0x00000011  # Deprecated in KMIP 1.4, designated '(Reserved)' in KMIP 2.0
    )
    TRANSPARENT_ECMQV_PRIVATE_KEY = (
        0x00000012  # Deprecated in KMIP 1.4, designated '(Reserved)' in KMIP 2.0
    )
    TRANSPARENT_ECMQV_PUBLIC_KEY = (
        0x00000013  # Deprecated in KMIP 1.4, designated '(Reserved)' in KMIP 2.0
    )
    # KMIP 1.3
...
class Tags(enum.Enum):
    ...
    CERTIFICATE_ISSUER_ALTERNATIVE_NAME = (
        0x420016  # Deprecated, designated '(Reserved)' in KMIP 2.0
    )
    CERTIFICATE_ISSUER_DISTINGUISHED_NAME = (
        0x420017  # Deprecated, designated '(Reserved)' in KMIP 2.0
    )
    ...
    CERTIFICATE_SUBJECT_ALTERNATIVE_NAME = (
        0x42001B  # Deprecated, designated '(Reserved)' in KMIP 2.0
    )
    CERTIFICATE_SUBJECT_DISTINGUISHED_NAME = (
        0x42001C  # Deprecated, designated '(Reserved)' in KMIP 2.0
    )
...
def get_bit_mask_from_enumerations(enumerations):
    ...
    """
    return functools.reduce(lambda x, y: x | y, [z.value for z in enumerations])
