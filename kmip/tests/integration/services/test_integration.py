...
class TestIntegration(testtools.TestCase):
    ...
    def _create_symmetric_key(self, key_name=None):
        ...
        name = self.attr_factory.create_attribute(enums.AttributeType.NAME, key_name)
        ...
        return self.client.create(
            enums.ObjectType.SYMMETRIC_KEY, template_attribute, credential=None
        )
    ...
    def _check_result_status(self, result, result_status_type, result_status_value):
        """
    ...
    def test_symmetric_key_register_get_destroy(self):
        ...
        result = self.client.register(
            object_type, template_attribute, secret, credential=None
        )
    ...
    def test_key_pair_create_get_destroy(self):
        ...
        self._check_object_type(
            priv_key_result.object_type, ObjectType, ObjectType.PRIVATE_KEY
        )

        self._check_uuid(priv_key_result.uuid, str)
        self._check_result_status(pub_key_result, ResultStatus, ResultStatus.SUCCESS)
        self._check_object_type(
            pub_key_result.object_type, ObjectType, ObjectType.PUBLIC_KEY
        )
        ...
        self._check_result_status(
            destroy_priv_key_result, ResultStatus, ResultStatus.SUCCESS
        )
        ...
        self._check_result_status(
            destroy_pub_key_result, ResultStatus, ResultStatus.SUCCESS
        )
        ...
        self._check_result_status(
            priv_key_destroyed_result, ResultStatus, ResultStatus.OPERATION_FAILED
        )
        self._check_result_status(
            pub_key_destroyed_result, ResultStatus, ResultStatus.OPERATION_FAILED
        )
    ...
    def test_private_key_register_get_destroy(self):
        ...
        priv_key_result = self.client.register(
            priv_key_object_type,
    ...
    def test_public_key_register_get_destroy(self):
        ...
        pub_key_result = self.client.register(
            pub_key_object_type, public_template_attribute, pub_secret, credential=None
        )
        self._check_result_status(pub_key_result, ResultStatus, ResultStatus.SUCCESS)
        # Check that the returned key bytes match what was provided
    ...
    def test_cert_register_get_destroy(self):
        ...
        cert_result = self.client.register(
            cert_obj_type, cert_template_attribute, cert_obj, credential=None
        )
        ...
        self._check_object_type(
            cert_result.object_type, ObjectType, ObjectType.CERTIFICATE
        )
        ...
        self._check_result_status(
            cert_result_destroyed_result, ResultStatus, ResultStatus.OPERATION_FAILED
        )
    ...
    def test_passphrase_register_get_destroy(self):
        ...
        pass_result = self.client.register(
            pass_obj_type, pass_template_attribute, pass_obj, credential=None
        )
        ...
        self._check_object_type(
            pass_result.object_type, ObjectType, ObjectType.SECRET_DATA
        )
        ...
        self._check_result_status(
            pass_result_destroyed_result, ResultStatus, ResultStatus.OPERATION_FAILED
        )
    ...
    def test_opaque_data_register_get_destroy(self):
        ...
        opaque_obj_name_attr = Attribute(
            attribute_name=name, attribute_value=opaque_obj_value
        )
        ...
        opaque_obj = OpaqueObject(
            opaque_data_type=opaque_obj_data_type, opaque_data_value=opaque_obj_data
        )

        opaque_obj_result = self.client.register(
            opaque_obj_type, opaque_obj_template_attribute, opaque_obj, credential=None
        )
        ...
        self._check_object_type(
            opaque_obj_result.object_type, ObjectType, ObjectType.OPAQUE_DATA
        )
        ...
        self.logger.debug(
            "Destroying opaque object: "
            + opaque_obj_name
            + '\nWith " "UUID: '
            + opaque_obj_result.uuid
        )
        ...
        self._check_result_status(
            opaque_obj_result_destroyed_result,
            ResultStatus,
            ResultStatus.OPERATION_FAILED,
        )

        expected = ResultReason
        opaque_obj_observed = type(
            opaque_obj_result_destroyed_result.result_reason.value
        )
    ...
    def test_certificate_register_locate_destroy(self):
        ...
        name = self.attr_factory.create_attribute(enums.AttributeType.NAME, label)
        ...
        result = self.client.register(
            enums.ObjectType.CERTIFICATE, template_attribute, certificate
        )
        uid_a = result.uuid

        self.assertEqual(enums.ResultStatus.SUCCESS, result.result_status.value)
    ...
    def test_symmetric_key_create_getattributes_locate_destroy(self):
        ...
        result = self.client.get_attributes(
            uuid=uid_a, attribute_names=["Initial Date"]
        )
        ...
        result = self.client.get_attributes(
            uuid=uid_b, attribute_names=["Initial Date"]
        )
        ...
        result = self.client.locate(
            attributes=[
                self.attr_factory.create_attribute(
                    enums.AttributeType.INITIAL_DATE, start_time
                ),
                self.attr_factory.create_attribute(
        ...
        result = self.client.locate(
            attributes=[
                self.attr_factory.create_attribute(enums.AttributeType.NAME, key_name)
            ]
        )
        self.assertEqual(ResultStatus.SUCCESS, result.result_status.value)
        self.assertEqual(2, len(result.uuids))
    ...
    def test_split_key_register_get_destroy(self):
        ...
        result = self.client.register(
            ObjectType.SPLIT_KEY, template_attribute, secret, credential=None
        )
    ...
    def test_modify_delete_attribute(self):
        ...
        response_payload = self.client.send_request_payload(
            ...
            payloads.ModifyAttributeRequestPayload(
                ...
                attribute=self.attr_factory.create_attribute(
                    enums.AttributeType.NAME, "New Name", index=0
                ),
            ),
        )
        ...
        self.assertEqual(
            "New Name", response_payload.attribute.attribute_value.name_value.value
        )
        ...
        self.assertEqual(0, result.attributes[0].attribute_index.value)
        self.assertEqual(
            "New Name", result.attributes[0].attribute_value.name_value.value
        )
