...
class TestProxyKmipClient(testtools.TestCase):
    ...
    def test_create(self):
        ...
        result = results.CreateResult(contents.ResultStatus(status), uuid=key_id)
    ...
    def test_create_with_operation_policy_name(self):
        ...
        result = results.CreateResult(
            contents.ResultStatus(status), uuid=attr.UniqueIdentifier(key_id)
        )
    ...
    def test_create_on_operation_failure(self):
        ...
        self.assertRaisesRegex(KmipOperationFailure, error_msg, client.create, *args)
    ...
    def test_create_key_pair_with_operation_policy_name(self):
        ...
        pair_attributes = [opn_attribute, algorithm_attribute, length_attribute]
        template = obj.TemplateAttribute(
            attributes=pair_attributes, tag=enums.Tags.COMMON_TEMPLATE_ATTRIBUTE
        )
        ...
        with ProxyKmipClient() as client:
            ...
            public_uid, private_uid = client.create_key_pair(
                enums.CryptographicAlgorithm.RSA, 2048, operation_policy_name="test"
            )
    ...
    def test_create_key_pair_with_key_names(self):
        ...
        private_template = obj.TemplateAttribute(
            attributes=[
                self.attribute_factory.create_attribute(
                    enums.AttributeType.NAME, "Test_Private_Key"
                )
            ],
        ...
        public_template = obj.TemplateAttribute(
            attributes=[
                self.attribute_factory.create_attribute(
                    enums.AttributeType.NAME, "Test_Public_Key"
                )
            ],
    ...
    def test_create_key_pair_with_cryptographic_usage_masks(self):
        ...
        public_template = obj.TemplateAttribute(
            attributes=[public_usage_mask], tag=enums.Tags.PUBLIC_KEY_TEMPLATE_ATTRIBUTE
        )
    ...
    def test_create_key_pair_on_closed(self):
        ...
        self.assertRaises(ClientConnectionNotOpen, client.create_key_pair, *args)
    ...
    def test_create_key_pair_on_operation_failure(self):
        ...
        self.assertRaisesRegex(
            KmipOperationFailure, error_msg, client.create_key_pair, *args
        )
    ...
    def test_delete_attribute(self):
        ...
        with ProxyKmipClient() as client:
            ...
            args = (enums.Operation.DELETE_ATTRIBUTE, request_payload)
    ...
    def test_set_attribute(self):
        ...
        response_payload = payloads.SetAttributeResponsePayload(unique_identifier="1")

        with ProxyKmipClient() as client:
            client.proxy.send_request_payload.return_value = response_payload

            unique_identifier = client.set_attribute(
                "1", attribute_name="Sensitive", attribute_value=True
            )

            args = (enums.Operation.SET_ATTRIBUTE, request_payload)
            client.proxy.send_request_payload.assert_called_with(*args)
            self.assertEqual("1", unique_identifier)
    ...
    def test_modify_attribute(self):
        ...
        with ProxyKmipClient() as client:
            ...
            args = (enums.Operation.MODIFY_ATTRIBUTE, request_payload)
            client.proxy.send_request_payload.assert_called_with(*args)
            self.assertEqual("1", unique_identifier)
            self.assertIsNone(attribute)
    ...
    def test_rekey(self):
        ...
        """
        result = {"unique_identifier": "2", "result_status": enums.ResultStatus.SUCCESS}
    ...
    def test_rekey_on_invalid_offset(self):
        ...
        with ProxyKmipClient() as client:
            self.assertRaisesRegex(
                TypeError, "The offset must be an integer.", client.rekey, **kwargs
            )
    ...
    def test_rekey_on_closed(self):
        ...
        """
        client = ProxyKmipClient()
        kwargs = {"uid": "1", "offset": 10}

        self.assertRaises(ClientConnectionNotOpen, client.rekey, **kwargs)
    ...
    def test_rekey_on_operation_failure(self):
        ...
        client.open()
        client.proxy.rekey.return_value = result
        kwargs = {"uid": "1", "offset": 1, "deactivation_date": 10000}

        self.assertRaisesRegex(
            KmipOperationFailure, error_message, client.rekey, **kwargs
        )
    ...
    def test_check_on_invalid_lease_time(self):
        ...
        with ProxyKmipClient() as client:
            self.assertRaisesRegex(
                TypeError, "The lease time must be an integer.", client.check, **kwargs
            )
    ...
    def test_check_on_closed(self):
        ...
        self.assertRaises(ClientConnectionNotOpen, client.check, **kwargs)
    ...
    def test_check_on_operation_failure(self):
        ...
        self.assertRaisesRegex(
            KmipOperationFailure, error_message, client.check, **kwargs
        )
    ...
    def test_get(self):
        ...
        secret = objects.SymmetricKey(
            ...
            128,
            (b"\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0A\x0B\x0C\x0D\x0E" b"\x0F"),
        )
        fact = factory.ObjectFactory()

        result = results.GetResult(
            contents.ResultStatus(enums.ResultStatus.SUCCESS),
            uuid=attr.PublicKeyUniqueIdentifier("aaaaaaaa-1111-2222-3333-ffffffffffff"),
        ...
        with ProxyKmipClient() as client:
            ...
            client.proxy.get.assert_called_with(
                "aaaaaaaa-1111-2222-3333-ffffffffffff", key_wrapping_specification=None
            )
        ...
        result = results.GetAttributesResult(
            ...
            attributes=[
                ...
                obj.Attribute(
                    ...
                    attribute_value=attr.ObjectType(enums.ObjectType.SYMMETRIC_KEY),
                ),
            ],
        )
    ...
    def test_get_attributes_on_invalid_uid(self):
        ...
        with ProxyKmipClient() as client:
            self.assertRaisesRegex(
                TypeError, "uid must be a string", client.get_attributes, *args
            )
    ...
    def test_get_attributes_on_closed(self):
        ...
        """
        client = ProxyKmipClient()
        args = ["aaaaaaaa-1111-2222-3333-ffffffffffff", ["Name", "Object Type"]]
        self.assertRaises(ClientConnectionNotOpen, client.get_attributes, *args)
    ...
    def test_get_attribute_list_on_closed(self):
        ...
        client = ProxyKmipClient()
        args = ["aaaaaaaa-1111-2222-3333-ffffffffffff"]
        self.assertRaises(ClientConnectionNotOpen, client.get_attribute_list, *args)
    ...
    def test_activate(self):
        ...
        with ProxyKmipClient() as client:
            ...
            result = client.activate("aaaaaaaa-1111-2222-3333-ffffffffffff")
    ...
    def test_activate_on_closed(self):
        ...
        client = ProxyKmipClient()
        args = ["aaaaaaaa-1111-2222-3333-ffffffffffff"]
        self.assertRaises(ClientConnectionNotOpen, client.activate, *args)
    ...
    def test_activate_on_operation_failure(self):
        ...
        self.assertRaisesRegex(KmipOperationFailure, error_msg, client.activate, *args)
    ...
    def test_revoke(self):
        ...
        with ProxyKmipClient() as client:
            ...
            result = client.revoke(
                revocation_reason, uuid, revocation_message, compromise_occurrence_date
            )
    ...
    def test_revoke_on_invalid_inputs(self):
        ...
        with ProxyKmipClient() as client:
            self.assertRaisesRegex(
                TypeError, "uid must be a string", client.revoke, *args
            )

        args = [
            revocation_reason,
            uuid,
            revocation_message_invalid,
            compromise_occurrence_date,
        ]
        with ProxyKmipClient() as client:
            self.assertRaisesRegex(
                TypeError, "revocation_message must be a string", client.revoke, *args
            )
    ...
    def test_revoke_on_closed(self):
        ...
        revocation_message = "Key compromised!"
        compromise_occurrence_date = 1
        args = [revocation_reason, uuid, revocation_message, compromise_occurrence_date]
        self.assertRaises(ClientConnectionNotOpen, client.revoke, *args)
    ...
    def test_revoke_on_operation_failure(self):
        ...
        error_msg = str(KmipOperationFailure(status, reason, revocation_message))
        ...
        self.assertRaisesRegex(KmipOperationFailure, error_msg, client.revoke, *args)
    ...
    def test_destroy(self):
        ...
        with ProxyKmipClient() as client:
            ...
            result = client.destroy("aaaaaaaa-1111-2222-3333-ffffffffffff")
    ...
    def test_destroy_on_operation_failure(self):
        ...
        self.assertRaisesRegex(KmipOperationFailure, error_msg, client.destroy, *args)
    ...
    def test_register_on_operation_failure(self):
        ...
        key = objects.SymmetricKey(enums.CryptographicAlgorithm.AES, 128, key_value)
        ...
        self.assertRaisesRegex(KmipOperationFailure, error_msg, client.register, *args)
    ...
    def test_derive_key_on_closed(self):
        ...
        self.assertRaises(ClientConnectionNotOpen, client.derive_key, *args, **kwargs)
    ...
    def test_derive_key_on_operation_failure(self):
        ...
        self.assertRaisesRegex(
            KmipOperationFailure, error_message, client.derive_key, *args, **kwargs
        )
    ...
    def test_encrypt_on_invalid_inputs(self):
        ...
        self.assertRaisesRegex(
            TypeError, "data must be bytes", client.encrypt, *args, **kwargs
        )
        ...
        self.assertRaisesRegex(
            TypeError, "uid must be a string", client.encrypt, *args, **kwargs
        )
        ...
        self.assertRaisesRegex(
            TypeError, "iv_counter_nonce must be bytes", client.encrypt, *args, **kwargs
        )
    ...
    def test_encrypt_on_closed(self):
        ...
        self.assertRaises(ClientConnectionNotOpen, client.encrypt, *args, **kwargs)
    ...
    def test_encrypt_on_operation_failure(self):
        ...
        self.assertRaisesRegex(
            KmipOperationFailure, error_message, client.encrypt, *args, **kwargs
        )
    ...
    def test_decrypt_on_invalid_inputs(self):
        ...
        self.assertRaisesRegex(
            TypeError, "data must be bytes", client.decrypt, *args, **kwargs
        )
        ...
        self.assertRaisesRegex(
            TypeError, "uid must be a string", client.decrypt, *args, **kwargs
        )
        ...
        self.assertRaisesRegex(
            TypeError, "iv_counter_nonce must be bytes", client.decrypt, *args, **kwargs
        )
    ...
    def test_decrypt_on_closed(self):
        ...
        self.assertRaises(ClientConnectionNotOpen, client.decrypt, *args, **kwargs)
    ...
    def test_decrypt_on_operation_failure(self):
        ...
        self.assertRaisesRegex(
            KmipOperationFailure, error_message, client.decrypt, *args, **kwargs
        )
    ...
    def test_sign_on_invalid_inputs(self):
        ...
        self.assertRaisesRegex(
            TypeError, "Data to be signed must be bytes.", client.sign, *args, **kwargs
        )
    ...
    def test_signature_verify_on_closed(self):
        ...
        self.assertRaises(
            ClientConnectionNotOpen, client.signature_verify, *args, **kwargs
        )
    ...
    def test_mac_on_operation_failure(self):
        ...
        self.assertRaisesRegex(KmipOperationFailure, error_msg, client.mac, *args)
    ...
    def test_locate(self):
        ...
        result = results.LocateResult(
            contents.ResultStatus(enums.ResultStatus.SUCCESS), uuids=unique_identifiers
        )
        ...
        with ProxyKmipClient() as client:
            ...
            uuids = client.locate(
                maximum_items, storage_status_mask, object_group_member, attributes
            )
    ...
    def test_locate_on_operation_failure(self):
        ...
        client.open()
        client.proxy.locate.return_value = result
        args = [maximum_items, storage_status_mask, object_group_member, attributes]

        self.assertRaisesRegex(KmipOperationFailure, error_msg, client.locate, *args)
    ...
    def test_locate_on_closed(self):
        ...
        args = [maximum_items, storage_status_mask, object_group_member, attributes]
        self.assertRaises(ClientConnectionNotOpen, client.locate, *args)
    ...
    def test_build_encryption_key_information(self):
        ...
        self.assertIsInstance(
            result.cryptographic_parameters, obj.CryptographicParameters
        )
        self.assertEqual(
    ...
    def test_build_key_wrapping_specification(self):
        ...
        self.assertIsInstance(
            result.encryption_key_information, obj.EncryptionKeyInformation
        )
        info = result.encryption_key_information
        self.assertEqual("1", info.unique_identifier)
        self.assertIsInstance(
            info.cryptographic_parameters, obj.CryptographicParameters
        )
        self.assertEqual(
            enums.CryptographicAlgorithm.AES,
        ...
        self.assertIsInstance(
            result.mac_signature_key_information, obj.MACSignatureKeyInformation
        )
