...
class TestObjectFactory(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.secret_bytes = b"\x53\x65\x63\x72\x65\x74\x50\x61\x73\x73\x77\x6F\x72\x64"
        self.opaque_bytes = b"\x53\x65\x63\x72\x65\x74\x50\x61\x73\x73\x77\x6F\x72\x64"
    ...
    def test_convert_symmetric_key_core_to_pie(self):
        ...
        algorithm = attributes.CryptographicAlgorithm(enums.CryptographicAlgorithm.AES)
    ...
    def test_convert_public_key_core_to_pie(self):
        ...
        algorithm = attributes.CryptographicAlgorithm(enums.CryptographicAlgorithm.RSA)
    ...
    def test_convert_certificate_pie_to_core(self):
        ...
        self.assertEqual(pie_cert.certificate_type, core_cert.certificate_type.value)
    ...
    def test_convert_certificate_core_to_pie(self):
        ...
        self.assertEqual(core_cert.certificate_type.value, pie_cert.certificate_type)
    ...
    def test_convert_secret_data_core_to_pie(self):
        ...
        data_type = secrets.SecretData.SecretDataType(enums.SecretDataType.PASSWORD)
    ...
    def test_convert_opaque_object_pie_to_core(self):
        ...
        object.
        """
        pie_obj = pobjects.OpaqueObject(self.opaque_bytes, enums.OpaqueDataType.NONE)
    ...
    def test_convert_opaque_object_core_to_pie(self):
        ...
        opaque_data_value = secrets.OpaqueObject.OpaqueDataValue(self.opaque_bytes)
    ...
    def test_convert_split_key_core_to_pie(self):
        ...
        key_block = cobjects.KeyBlock(
            ...
            key_compression_type=None,
            key_value=cobjects.KeyValue(cobjects.KeyMaterial(self.symmetric_bytes)),
    ...
    def _test_core_key(self, key, algorithm, length, value, format_type):
        ...
        self.assertEqual(cryptographic_algorithm.value, algorithm)

        cryptographic_length = key_block.cryptographic_length
        self.assertIsInstance(cryptographic_length, attributes.CryptographicLength)
    ...
    def test_build_cryptographic_parameters(self):
        ...
        self.assertEqual(
            enums.HashingAlgorithm.SHA_256, result.get("hashing_algorithm")
        )
        ...
        self.assertEqual(
            enums.CryptographicAlgorithm.AES, result.get("cryptographic_algorithm")
        )
