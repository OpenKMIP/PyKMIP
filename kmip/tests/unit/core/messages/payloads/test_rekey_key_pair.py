...
class TestRekeyKeyPairRequestPayload(TestCase):
    def setUp(self):
        ...
        self.private_key_uuid = attributes.PrivateKeyUniqueIdentifier(self.uuid)
    ...
    def test_validate_with_invalid_private_key_unique_identifier(self):
        ...
        self.assertRaisesRegex(
            TypeError,
            "invalid private key unique identifier",
            payloads.RekeyKeyPairRequestPayload,
            **kwargs
        )
    ...
    def test_validate_with_invalid_offset(self):
        ...
        self.assertRaisesRegex(
            TypeError, "invalid offset", payloads.RekeyKeyPairRequestPayload, **kwargs
        )
    ...
    def test_validate_with_invalid_common_template_attribute(self):
        ...
        self.assertRaisesRegex(
            TypeError,
            "invalid common template attribute",
            payloads.RekeyKeyPairRequestPayload,
            **kwargs
        )
    ...
    def test_validate_with_invalid_private_key_template_attribute(self):
        ...
        self.assertRaisesRegex(
            TypeError,
            "invalid private key template attribute",
            payloads.RekeyKeyPairRequestPayload,
            **kwargs
        )
    ...
    def test_validate_with_invalid_public_key_template_attribute(self):
        ...
        self.assertRaisesRegex(
            TypeError,
            "invalid public key template attribute",
            payloads.RekeyKeyPairRequestPayload,
            **kwargs
        )
    ...
    def _test_read(
        ...
        self.assertEqual(
            common_template_attribute, payload.common_template_attribute, msg
        )
        ...
        self.assertEqual(
            private_key_template_attribute, payload.private_key_template_attribute, msg
        )
        ...
        self.assertEqual(
            public_key_template_attribute, payload.public_key_template_attribute, msg
        )
