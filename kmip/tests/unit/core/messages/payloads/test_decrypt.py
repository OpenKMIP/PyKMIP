...
class TestDecryptRequestPayload(testtools.TestCase):
    ...
    def test_read_valid(self):
        """
        Test that a Decrypt response payload can be read from a valid byte
        stream.
        """
        self.test_read()
    ...
    def test_write_valid(self):
        """
        Test that a Decrypt response payload can be written to a byte stream.
        """
        self.test_write()

    def test_read_write_roundtrip(self):
        """
        Test that a Decrypt response payload can be read and written without
    ...
    def test_eq(self):
        """
        Test that two Decrypt response payloads with the same data are equal.
        """
        self.test_equal_on_equal()

    def test_ne(self):
        """
        Test that two Decrypt response payloads with different data are not
        equal.
        """
    ...
    def test_read_valid(self):
        """
        Test that a Decrypt request payload can be read from a valid byte
        stream.
        """
        self.test_read()
    ...
    def test_write_valid(self):
        """
        Test that a Decrypt request payload can be written to a byte stream.
        """
        self.test_write()

    def test_read_write_roundtrip(self):
        """
        Test that a Decrypt request payload can be read and written without
        changing the encoded bytes.
        """
        payload = payloads.DecryptRequestPayload()
        payload.read(utils.BytearrayStream(self.full_encoding.buffer))
    ...
    def test_eq(self):
        """
        Test that two Decrypt request payloads with the same data are equal.
        """
        self.test_equal_on_equal()

    def test_ne(self):
        """
        Test that two Decrypt request payloads with different data are not
        equal.
        """
        self.test_not_equal_on_not_equal_unique_identifier()
