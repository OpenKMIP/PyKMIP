...
class TestRequestBatchItem(testtools.TestCase):
    ...
    def test_invalid_ephemeral(self):
        ...
        args = (messages.RequestBatchItem(), "ephemeral", "invalid")
        self.assertRaisesRegex(
            TypeError, "The ephemeral value must be a boolean.", setattr, *args
        )
    ...
    def test_read_kmip_2_0(self):
        ...
        request_batch_item.read(
            self.encoding_kmip_2_0, kmip_version=enums.KMIPVersion.KMIP_2_0
        )

        self.assertEqual(enums.Operation.DESTROY, request_batch_item.operation.value)
    ...
    def test_write_kmip_2_0(self):
        ...
        request_batch_item.write(buffer, kmip_version=enums.KMIPVersion.KMIP_2_0)
...
class TestResponseHeader(testtools.TestCase):
    ...
    def test_invalid_server_hashed_password(self):
        ...
        args = (messages.ResponseHeader(), "server_hashed_password", [])
        self.assertRaisesRegex(
            TypeError,
            "The server hashed password must be a binary string.",
            setattr,
    ...
    def test_read_kmip_2_0(self):
        ...
        self.assertEqual(
            contents.ProtocolVersion(major=2, minor=0), response_header.protocol_version
        )
    ...
    def test_write_kmip_2_0(self):
        ...
        buffer = utils.BytearrayStream()
        response_header.write(buffer, kmip_version=enums.KMIPVersion.KMIP_2_0)
...
class TestRequestMessage(TestCase):
    ...
    def test_create_request_read(self):
        ...
        self.assertIsInstance(
            ...
            msg.format(messages.RequestHeader, type(request_header)),
        )
        ...
        self.assertIsInstance(
            ...
            msg.format(contents.ProtocolVersion, type(protocol_version)),
        )
        ...
        self.assertIsInstance(
            protocol_version_major, exp_type, msg.format(exp_type, rcv_type)
        )
        msg = "Bad protocol version major value: expected {0}, received {1}"
        self.assertEqual(
            1, protocol_version_major, msg.format(1, protocol_version_major)
        )
        ...
        self.assertIsInstance(
            protocol_version_minor, exp_type, msg.format(exp_type, rcv_type)
        )
        msg = "Bad protocol version minor value: expected {0}, received {1}"
        self.assertEqual(
            1, protocol_version_minor, msg.format(1, protocol_version_minor)
        )
        ...
        self.assertIsInstance(
            batch_count,
            contents.BatchCount,
            msg.format(contents.BatchCount, type(batch_count)),
        )
        ...
        self.assertEqual(
            1,
            len(batch_items),
            self.msg.format("batch items", "length", 1, len(batch_items)),
        )
        ...
        self.assertIsInstance(
            batch_item,
            messages.RequestBatchItem,
            msg.format(messages.RequestBatchItem, type(batch_item)),
        )
        ...
        self.assertIsInstance(
            operation,
            contents.Operation,
            msg.format(contents.Operation, type(operation)),
        )
        msg = "Bad operation value: expected {0}, received {1}"
        self.assertEqual(
            enums.Operation.CREATE,
            operation.value,
            msg.format(enums.Operation.CREATE, operation.value),
        )
        ...
        self.assertIsInstance(
            ...
            msg.format(payloads.CreateRequestPayload, type(request_payload)),
        )
        ...
        self.assertIsInstance(
            object_type,
            enums.ObjectType,
            msg.format(enums.ObjectType, type(object_type)),
        )
        msg = "Bad object type value: expected {0}, received {1}"
        self.assertEqual(
            enums.ObjectType.SYMMETRIC_KEY,
            object_type,
            msg.format(enums.ObjectType.SYMMETRIC_KEY, object_type),
        )
        ...
        self.assertIsInstance(
            ...
            msg.format(objects.TemplateAttribute, type(template_attribute)),
        )
        ...
        self.assertIsInstance(
            attributes,
            list,
            self.msg.format("attributes", "type", list, type(attributes)),
        )
        self.assertEqual(
            3,
            len(attributes),
            self.msg.format("attributes", "length", 3, len(attributes)),
        )
        ...
        self.assertIsInstance(
            attribute_a,
            objects.Attribute,
            self.msg.format("attribute", "type", objects.Attribute, type(attribute_a)),
        )
        ...
        self.assertIsInstance(
            attribute_value,
            exp_type,
            self.msg.format("attribute value", "type", exp_type, rcv_type),
        )
        self.assertEqual(
        ...
        self.assertIsInstance(
            attribute_b,
            objects.Attribute,
            self.msg.format("attribute", "type", objects.Attribute, type(attribute_b)),
        )
        ...
        self.assertEqual(
            ...
            attribute_name.value,
            self.msg.format(
                "attribute name", "value", "Cryptographic Length", attribute_name.value
            ),
        )
    ...
    def test_create_request_write(self):
        ...
        request_header = messages.RequestHeader(
            protocol_version=prot_ver, batch_count=batch_count
        )
        ...
        req_pl = payloads.CreateRequestPayload(
            object_type=object_type, template_attribute=temp_attr
        )
        batch_item = messages.RequestBatchItem(
            operation=operation, request_payload=req_pl
        )
        req_message = messages.RequestMessage(
            request_header=request_header, batch_items=[batch_item]
        )
        ...
        self.assertEqual(
            len_exp,
            len_rcv,
            self.msg.format("request message", "write", len_exp, len_rcv),
        )
    ...
    def test_get_request_read(self):
        ...
        self.assertEqual(
            enums.Operation.GET,
            operation.value,
            msg.format(enums.Operation.GET, operation.value),
        )
        ...
        self.assertIsInstance(
            ...
            msg.format(payloads.GetRequestPayload, type(request_payload)),
        )
        ...
        self.assertEqual(
            "49a1ca88-6bea-4fb2-b450-7e58802c3038", request_payload.unique_identifier
        )
    ...
    def test_get_request_write(self):
        ...
        request_message = messages.RequestMessage(
            request_header=req_header, batch_items=[batch_item]
        )
    ...
    def test_destroy_request_read(self):
        ...
        self.assertIsInstance(
            ...
            msg.format(attr.UniqueIdentifier, type(unique_identifier)),
        )
        msg = "Bad unique identifier value: expected {0}, received {1}"
    ...
    def test_destroy_request_write(self):
        ...
        request_payload = payloads.DestroyRequestPayload(unique_identifier=uuid)
        batch_item = messages.RequestBatchItem(
            operation=operation, request_payload=request_payload
        )
        request_message = messages.RequestMessage(
    ...
    def test_register_request_read(self):
        ...
        for batch_item in batch_items:
            ...
            rcv_type = type(request_payload)
            self.assertIsInstance(
                request_payload, exp_type, msg.format(exp_type, rcv_type)
            )
            ...
            self.assertIsInstance(
                template_attribute, exp_type, msg.format(exp_type, rcv_type)
            )
    ...
    def test_register_request_write(self):
        ...
        value = attr.ApplicationSpecificInformation(
            application_namespace=ap_n_name, application_data=ap_n_value
        )
        attribute = objects.Attribute(attribute_name=name, attribute_value=value)
        attributes.append(attribute)
    ...
    def test_locate_request_read(self):
        ...
        self.assertEqual(
            2,
            len(attributes),
            self.msg.format("attribute", "length", 2, len(attributes)),
        )
        ...
        self.assertEqual(
            "Name",
            attribute_name.value,
            self.msg.format("attribute name", "value", "Name", attribute_name.value),
        )
        attribute_value = attribute_b.attribute_value
    ...
    def test_mac_request_read(self):
        ...
        msg = "Bad protocol version minor value: expected {0}, received {1}"
        self.assertEqual(
            2, protocol_version_minor, msg.format(2, protocol_version_minor)
        )
        ...
        self.assertEqual(
            enums.Operation.MAC,
            operation.value,
            msg.format(enums.Operation.MAC, operation.value),
        )
        ...
        self.assertIsInstance(
            ...
            msg.format(payloads.MACRequestPayload, type(request_payload)),
        )
        ...
        msg = "Bad unique identifier value: expected {0}, received {1}"
        self.assertEqual(
            "1", unique_identifier.value, msg.format("1", unique_identifier.value)
        )
        ...
        self.assertEqual(
            exp_value,
            data.value,
            msg.format(binascii.hexlify(exp_value), binascii.hexlify(data.value)),
        )
...
class TestResponseMessage(TestCase):
    ...
    def test_create_response_read(self):
        ...
        self.assertIsInstance(
            ...
            exp_type,
            self.msg.format("protocol version major", "type", exp_type, rcv_type),
        )
        self.assertEqual(
            1,
            protocol_version_major,
        ...
        self.assertIsInstance(
            ...
            int,
            self.msg.format("protocol version minor", "type", exp_type, rcv_type),
        )
        self.assertEqual(
            1,
            protocol_version_minor,
        ...
        self.assertEqual(
            time_stamp.value,
            value,
            self.msg.format("time stamp", "value", time_stamp.value, value),
        )
        ...
        self.assertEqual(
            1,
            batch_count.value,
            self.msg.format("batch count", "value", 1, batch_count.value),
        )
        ...
        self.assertIsInstance(
            batch_items,
            list,
            self.msg.format("batch items", "type", list, type(batch_items)),
        )
        ...
        for batch_item in batch_items:
            self.assertIsInstance(
                ...
                self.msg.format(
                    "batch item", "type", messages.ResponseBatchItem, type(batch_item)
                ),
            )
            ...
            self.assertEqual(
                ...
                operation.value,
                self.msg.format(
                    "operation", "value", enums.Operation.CREATE, operation.value
                ),
            )
            ...
            self.assertIsInstance(
                ...
                self.msg.format(
                    "result status", "type", contents.ResultStatus, type(result_status)
                ),
            )
            self.assertEqual(
            ...
            self.assertIsInstance(
                response_payload,
                exp_type,
                self.msg.format("response payload", "type", exp_type, rcv_type),
            )
            ...
            self.assertEqual(
                ...
                object_type,
                self.msg.format(
                    "object type", "value", enums.ObjectType.SYMMETRIC_KEY, object_type
                ),
            )
            ...
            self.assertEqual(
                value,
                unique_identifier,
                self.msg.format("unique identifier", "value", unique_identifier, value),
            )
    ...
    def test_create_response_write(self):
        ...
        batch_count = contents.BatchCount(1)
        response_header = messages.ResponseHeader(
            protocol_version=prot_ver, time_stamp=time_stamp, batch_count=batch_count
        )
        operation = contents.Operation(enums.Operation.CREATE)
        ...
        resp_pl = payloads.CreateResponsePayload(
            object_type=object_type, unique_identifier=uuid
        )
        batch_item = messages.ResponseBatchItem(
            operation=operation, result_status=result_status, response_payload=resp_pl
        )
        rm = messages.ResponseMessage(
            response_header=response_header, batch_items=[batch_item]
        )
        ...
        self.assertEqual(
            len_exp,
            len_rcv,
            self.msg.format("response message", "write", len_exp, len_rcv),
        )
    ...
    def test_get_response_read(self):
        ...
        for batch_item in batch_items:
            ...
            self.assertEqual(
                enums.ObjectType.SYMMETRIC_KEY, response_payload.object_type
            )
            self.assertEqual(
            ...
            self.assertIsInstance(
                secret,
                SymmetricKey,
                self.msg.format("secret", "type", SymmetricKey, type(secret)),
            )
            ...
            self.assertIsInstance(
                key_block,
                objects.KeyBlock,
                self.msg.format("key_block", "type", objects.KeyBlock, type(key_block)),
            )
            ...
            self.assertIsInstance(
                key_format_type,
                exp_type,
                self.msg.format("key_format_type", "type", exp_type, rcv_type),
            )
            ...
            self.assertIsInstance(
                key_value,
                objects.KeyValue,
                self.msg.format("key_value", "type", objects.KeyValue, type(key_value)),
            )
            ...
            self.assertIsInstance(
                ...
                objects.KeyMaterial,
                self.msg.format(
                    "key_material", "type", objects.KeyMaterial, type(key_material)
                ),
            )
            exp = utils.hexlify_bytearray(value)
            obs = utils.hexlify_bytearray(key_material.value)
            self.assertEqual(
                exp, obs, self.msg.format("key_material", "value", exp, obs)
            )
            ...
            self.assertIsInstance(
                cryptographic_algorithm,
                exp_type,
                self.msg.format("cryptographic_algorithm", "type", exp_type, rcv_type),
            )
            exp = enums.CryptographicAlgorithm.TRIPLE_DES
            obs = cryptographic_algorithm.value
            self.assertEqual(
                exp, obs, self.msg.format("cryptographic_algorithm", "value", exp, obs)
            )
            ...
            self.assertEqual(
                exp, obs, self.msg.format("cryptographic_length", "value", exp, obs)
            )
    ...
    def test_get_response_write(self):
        ...
        self.assertEqual(
            len_exp,
            len_rcv,
            self.msg.format("get response message", "write", len_exp, len_rcv),
        )
    ...
    def test_destroy_response_read(self):
        ...
        self.assertIsInstance(
            response_header,
            messages.ResponseHeader,
            msg.format(messages.ResponseHeader, type(response_header)),
        )
        ...
        for batch_item in batch_items:
            ...
            self.assertIsInstance(
                batch_item,
                messages.ResponseBatchItem,
                msg.format(messages.ResponseBatchItem, type(batch_item)),
            )
            ...
            rcv_type = type(response_payload)
            self.assertIsInstance(
                response_payload, exp_type, msg.format(exp_type, rcv_type)
            )
    ...
    def test_destroy_response_write(self):
        ...
        batch_count = contents.BatchCount(1)
        resp_hdr = messages.ResponseHeader(
            protocol_version=prot_ver, time_stamp=time_stamp, batch_count=batch_count
        )
        ...
        response_message = messages.ResponseMessage(
            response_header=resp_hdr, batch_items=[batch_item]
        )
    ...
    def test_register_response_read(self):
        ...
        for batch_item in batch_items:
            ...
            self.assertIsInstance(
                unique_identifier,
                six.string_types,
                msg.format(six.string_types, type(unique_identifier)),
            )
            msg = "Bad unique identifier value: expected {0}, received {1}"
    ...
    def test_mac_response_read(self):
        ...
        self.assertEqual(
            ...
            protocol_version_minor,
            self.msg.format(
                "protocol version minor", "value", 2, protocol_version_minor
            ),
        )
        ...
        for batch_item in batch_items:
            ...
            self.assertEqual(
                ...
                operation.value,
                self.msg.format(
                    "operation", "value", enums.Operation.MAC, operation.value
                ),
            )
            ...
            self.assertEqual(
                ...
                self.msg.format(
                    "unique identifier", "value", unique_identifier.value, value
                ),
            )
            ...
            self.assertIsInstance(
                mac_data,
                objects.MACData,
                self.msg.format("secret", "type", objects.MACData, type(mac_data)),
            )
            self.assertEqual(
                value,
                mac_data.value,
    ...
    def test_mac_response_write(self):
        ...
        resp_pl = payloads.MACResponsePayload(
            unique_identifier=uniq_id, mac_data=mac_data
        )
        batch_item = messages.ResponseBatchItem(
            operation=operation, result_status=result_status, response_payload=resp_pl
        )
    ...
    def test_message_invalid_response_write(self):
        ...
        result_reason = contents.ResultReason(enums.ResultReason.INVALID_MESSAGE)
