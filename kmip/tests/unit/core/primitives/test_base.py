...
class TestBase(testtools.TestCase):
    ...
    def test_is_oversized_error(self):
        ...
        base = primitives.Base()
        self.assertRaises(
            exceptions.StreamNotEmptyError, base.is_oversized, self.stream
        )
    ...
    def test_read_tag_invalid(self):
        ...
        base = primitives.Base()
        self.stream = utils.BytearrayStream(encoding)
        self.assertRaises(exceptions.ReadValueError, base.read_tag, self.stream)
    ...
    def test_read_type_error(self):
        ...
        base = primitives.Base()
        self.assertRaises(exceptions.ReadValueError, base.read_type, self.stream)
    ...
    def test_read_length_underflow(self):
        ...
        base = primitives.Base()
        base.length = 4
        self.assertRaises(exceptions.ReadValueError, base.read_length, self.stream)
    ...
    def test_write_tag(self):
        ...
        self.assertEqual(
            ...
            self.bad_write.format(
                "tag", "{0} bytes".format(len_exp), "{0} bytes".format(len_rcv)
            ),
        )
    ...
    def test_write_type(self):
        ...
        self.assertEqual(
            ...
            len_rcv,
            self.bad_write.format(
                "type", "{0} bytes".format(len_exp), "{0} bytes".format(len_rcv)
            ),
        )
    ...
    def test_write_length(self):
        ...
        self.assertEqual(
            ...
            len_rcv,
            self.bad_write.format(
                "length", "{0} bytes".format(len_exp), "{0} bytes".format(len_rcv)
            ),
        )
    ...
    def test_write(self):
        ...
        self.assertEqual(
            ...
            len_rcv,
            self.bad_write.format(
                "type/length", "{0} bytes".format(len_exp), "{0} bytes".format(len_rcv)
            ),
        )
        self.assertEqual(encoding, result, self.bad_encoding.format("type/length"))
