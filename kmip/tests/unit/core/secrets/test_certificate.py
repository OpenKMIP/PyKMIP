...
class TestCertificate(TestCase):
    ...
    def test_read_a(self):
        ...
        """
        self._test_read(
            self.encoding_a, self.certificate_type_a, self.certificate_value_a
        )
    ...
    def test_read_b(self):
        ...
        """
        self._test_read(
            self.encoding_b, self.certificate_type_b, self.certificate_value_b
        )

    def _test_write(self, stream, certificate_type, certificate_value):
        certificate = Certificate(
            certificate_type=certificate_type, certificate_value=certificate_value
        )
    ...
    def test_repr(self):
        ...
        certificate_type = "certificate_type={0}".format(str(self.certificate_type_b))
        certificate_value = "certificate_value=b'{0}'".format(
            str(self.certificate_value_b)
        )

        expected = "Certificate({0}, {1})".format(certificate_type, certificate_value)
