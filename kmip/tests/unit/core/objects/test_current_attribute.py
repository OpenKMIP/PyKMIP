...
class TestCurrentAttribute(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.empty_encoding = utils.BytearrayStream(b"\x42\x01\x3C\x01\x00\x00\x00\x00")
    ...
    def test_invalid_attribute(self):
        ...
        args = (objects.CurrentAttribute(), "attribute", "invalid")
        self.assertRaisesRegex(
            TypeError,
            "The attribute must be a Base object, not a {}.".format(type("invalid")),
            setattr,
    ...
    def test_read(self):
        ...
        self.assertIsInstance(current_attribute.attribute, primitives.Enumeration)
        self.assertEqual(
            current_attribute.attribute.value, enums.CryptographicAlgorithm.AES
        )
