...
class TestResponsePayloadFactory(testtools.TestCase):
    ...
    def test_create_get_attributes_list_payload(self):
        ...
        self._test_payload_type(payload, payloads.GetAttributeListResponsePayload)
    ...
    def test_create_discover_versions_payload(self):
        ...
        self._test_payload_type(payload, payloads.DiscoverVersionsResponsePayload)
    ...
    def test_create_signature_verify_payload(self):
        ...
        self._test_payload_type(payload, payloads.SignatureVerifyResponsePayload)
