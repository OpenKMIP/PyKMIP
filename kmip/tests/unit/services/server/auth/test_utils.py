...
class TestUtils(testtools.TestCase):
    ...
    def setUp(self):
        ...
        subject = issuer = x509.Name(
            [x509.NameAttribute(x509.NameOID.COMMON_NAME, "Jane Doe")]
        )
        ...
        self.certificate_no_name = (
            ...
            .issuer_name(issuer_no_common_name)
            .public_key(private_key.public_key())
            .serial_number(x509.random_serial_number())
            .not_valid_before(datetime.datetime.utcnow())
            .not_valid_after(datetime.datetime.utcnow() + datetime.timedelta(days=1))
    ...
    def test_get_certificate_from_connection(self):
        ...
        result = utils.get_certificate_from_connection(mock_connection)
    ...
    def test_get_extended_key_usage_from_certificate(self):
        ...
        certificate.
        """
        extension = utils.get_extended_key_usage_from_certificate(self.certificate)
    ...
    def test_get_common_names_from_certificate(self):
        ...
        """
        common_names = utils.get_common_names_from_certificate(self.certificate)
    ...
    def test_get_common_names_from_certificate_no_common_names(self):
        ...
        """
        common_names = utils.get_common_names_from_certificate(self.certificate_no_name)
    ...
    @mock.patch("kmip.services.server.auth.utils.get_common_names_from_certificate")
    def test_get_client_identity_from_certificate_multiple_names(self, mock_get):
        """
