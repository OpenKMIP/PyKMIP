...
class TestCryptographyEngine(testtools.TestCase):
    ...
    def test_create_symmetric_key(self):
        ...
        key = engine.create_symmetric_key(enums.CryptographicAlgorithm.AES, 256)
    ...
    def test_create_symmetric_key_with_invalid_algorithm(self):
        ...
        args = ["invalid", 256]
        self.assertRaises(exceptions.InvalidField, engine.create_symmetric_key, *args)
    ...
    def test_create_symmetric_key_with_cryptographic_failure(self):
        ...
        self.assertRaises(
            exceptions.CryptographicFailure, engine.create_symmetric_key, *args
        )
    ...
    def test_create_asymmetric_key_with_invalid_algorithm(self):
        ...
        args = ["invalid", 2048]
        self.assertRaises(
            exceptions.InvalidField, engine.create_asymmetric_key_pair, *args
        )
    ...
    def test_create_asymmetric_key_with_invalid_length(self):
        ...
        self.assertRaises(
            exceptions.CryptographicFailure, engine.create_asymmetric_key_pair, *args
        )
    ...
    def test_mac(self):
        ...
        """
        key1 = b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" b"\x00\x00\x00\x00"
        key2 = b"\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" b"\x00\x00\x00\x00"
        key3 = b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" b"\x00\x00\x00\x00"
        ...
        # test hmac
        mac_data1 = engine.mac(enums.CryptographicAlgorithm.HMAC_SHA256, key1, data)
        mac_data2 = engine.mac(enums.CryptographicAlgorithm.HMAC_SHA256, key2, data)
        mac_data3 = engine.mac(enums.CryptographicAlgorithm.HMAC_SHA256, key3, data)
        self.assertNotEqual(mac_data1, mac_data2)
        self.assertEqual(mac_data1, mac_data3)
    ...
    def test_mac_with_invalid_algorithm(self):
        ...
        key = b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" b"\x00\x00\x00\x00"
        data = b"\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0A\x0B" b"\x0C\x0D\x0E\x0F"
    ...
    def test_encrypt_symmetric_invalid_cipher_mode(self):
        ...
        args = (
            ...
            b"\x0F\x0E\x0D\x0C\x0B\x0A\x09\x08" b"\x07\x06\x05\x04\x03\x02\x01\x00",
        )
        self.assertRaisesRegex(
            exceptions.InvalidField, "Cipher mode is required.", engine.encrypt, *args
        )
    ...
    def test_encrypt_symmetric_generate_iv(self):
        ...
        result = engine.encrypt(
            ...
            padding_method=enums.PaddingMethod.PKCS5,
            iv_nonce=(
                b"\x00\x10\x20\x30\x40\x50\x60\x70" b"\x80\x90\xA0\xB0\xC0\xD0\xE0\xF0"
            ),
        )
    ...
    def test_encrypt_asymmetric_invalid_hashing_algorithm(self):
        ...
        args = (enums.CryptographicAlgorithm.RSA, b"", b"")
        kwargs = {
    ...
    def test_decrypt_symmetric_invalid_cipher_mode(self):
        ...
        self.assertRaisesRegex(
            exceptions.InvalidField, "Cipher mode is required.", engine.decrypt, *args
        )
    ...
    def test_handle_symmetric_padding_invalid(self):
        ...
        args = (algorithms.AES, b"\x01\x02\x03\x04", None)
        ...
        args = (algorithms.AES, b"\x01\x02\x03\x04", "invalid")
    ...
    def test_derive_key_missing_hash_algorithm(self):
        ...
        args = (enums.DerivationMethod.HASH, 16)
    ...
    def test_derive_key_missing_derivation_data_and_key_material(self):
        ...
        args = (enums.DerivationMethod.HASH, 16)
        kwargs = {"hash_algorithm": enums.HashingAlgorithm.SHA_256}
    ...
    def test_derive_key_missing_salt(self):
        ...
        args = (enums.DerivationMethod.PBKDF2, 16)
        kwargs = {"hash_algorithm": enums.HashingAlgorithm.SHA_256}
    ...
    def test_derive_key_invalid_derivation_method(self):
        ...
        self.assertRaisesRegex(
            exceptions.InvalidField,
            "Derivation method 'invalid' is not a supported key derivation " "method.",
            engine.derive_key,
            *args,
            **kwargs
        )
    ...
    def test_wrap_key_invalid_wrapping_method(self):
        ...
        self.assertRaisesRegex(
            exceptions.InvalidField,
            "Wrapping method 'invalid' is not a supported key wrapping " "method.",
            engine.wrap_key,
            *args
        )
    ...
    def test_wrap_key_cryptographic_error(self):
        ...
        self.assertRaises(exceptions.CryptographicFailure, engine.wrap_key, *args)
    ...
    def test_verify_signature_mismatching_signing_algorithms(self):
        ...
        args = (b"", b"", b"", enums.PaddingMethod.PSS)
        kwargs = {
        ...
        self.assertRaisesRegex(
            exceptions.InvalidField,
            "The signing algorithm does not match the digital signature " "algorithm.",
    ...
    def test_verify_signature_mismatching_hashing_algorithms(self):
        ...
        self.assertRaisesRegex(
            exceptions.InvalidField,
            "The hashing algorithm does not match the digital signature " "algorithm.",
            engine.verify_signature,
            *args,
            **kwargs
        )
    ...
    def test_verify_signature_invalid_signing_key(self):
        ...
        args = ("invalid", b"", b"", enums.PaddingMethod.PSS)
        kwargs = {
            "signing_algorithm": enums.CryptographicAlgorithm.RSA,
            "hashing_algorithm": enums.HashingAlgorithm.SHA_1,
            "digital_signature_algorithm": None,
    ...
    def test_verify_signature_invalid_signature(self):
        ...
        args = (public_bytes, b"", b"", enums.PaddingMethod.PSS)
        kwargs = {
            "signing_algorithm": enums.CryptographicAlgorithm.RSA,
            "hashing_algorithm": enums.HashingAlgorithm.SHA_1,
            "digital_signature_algorithm": None,
        }
        self.assertFalse(engine.verify_signature(*args, **kwargs))
    ...
    params=[
        {
            ...
            "plain_text": (b"\x01\x02\x03\x04\x05\x06\x07\x08"),
            "cipher_text": (b"\xCE\xAD\x37\x3D\xB8\x0E\xAB\xF8"),
            "iv_nonce": None,
        },
        {
            ...
            "plain_text": (
                b"\xf3\x44\x81\xec\x3c\xc6\x27\xba" b"\xcd\x5d\xc3\xfb\x08\xf2\x73\xe6"
            ),
            "cipher_text": (
                b"\x03\x36\x76\x3e\x96\x6d\x92\x59" b"\x5a\x56\x7c\xc9\xce\x53\x7f\x5e"
            ),
            "iv_nonce": None,
        },
        {
        ...
        },
        {
            ...
            "iv_nonce": (
                b"\x85\x1e\x87\x64\x77\x6e\x67\x96" b"\xaa\xb7\x22\xdb\xb6\x44\xac\xe8"
            ),
            "plain_text": (
                b"\x62\x82\xb8\xc0\x5c\x5c\x15\x30" b"\xb9\x7d\x48\x16\xca\x43\x47\x62"
            ),
            "cipher_text": (
                b"\x6a\xcc\x04\x14\x2e\x10\x0a\x65" b"\xf5\x1b\x97\xad\xf5\x17\x2c\x41"
            ),
        },
        {
            "algorithm": enums.CryptographicAlgorithm.AES,
            ...
            "auth_additional_data": (
                b"\xd3\xc6\x2d\xa2\x77\x97\xba\x8e\x16" b"\x82\x1a\x1b\xe2\x47\x8a\x6f"
            ),
            "auth_tag_length": 16,
            "cipher_text": (
            ...
            "auth_tag": (
                b"\xbd\x9b\x6f\x23\xc9\x39\xa7\xd4" b"\xf5\xbe\xb0\x9d\x92\xf0\x17\x56"
            ),
        },
        {
            "algorithm": enums.CryptographicAlgorithm.AES,
            ...
            "iv_nonce": (b"\xba\x7a\x97\x67\x0f\xbb\x02\x62" b"\x24\x36\x92\x9d"),
            "plain_text": (
                b"\x8b\x4f\x7e\x75\x16\x31\xe7\x65" b"\xdc\x13\xfa\x63\xf0\x2f\x63\x4b"
            ),
            "auth_additional_data": (
                b"\x90\xee\x7e\x56\xf9\x59\x34\x76" b"\x1c\x39\xab\x75\x37\x2a\xc2\xc6"
            ),
            "auth_tag_length": 8,
            "cipher_text": (
                b"\x8c\xdc\x3f\x57\x48\xb1\x59\x36" b"\x6c\x94\xaf\x48\xe2\xcf\xa0\x98"
            ),
            "auth_tag": (b"\xfe\xb3\x8e\x85\x4e\xdf\x4d\x79"),
        },
        {
        ...
        },
        {
            ...
            "key": (
                b"\xb9\xba\x9f\xa3\x2c\xc4\x91\xd8" b"\xac\x2b\xeb\x5f\x99\x19\x3d\x57"
            ),
        ...
        },
        {
            ...
            "cipher_mode": enums.BlockCipherMode.OFB,
            "key": (
                b"\x2B\x7E\x15\x16\x28\xAE\xD2\xA6" b"\xAB\xF7\x15\x88\x09\xCF\x4F\x3C"
            ),
            "iv_nonce": (
                b"\x00\x01\x02\x03\x04\x05\x06\x07" b"\x08\x09\x0A\x0B\x0C\x0D\x0E\x0F"
            ),
            "plain_text": (
                b"\x6B\xC1\xBE\xE2\x2E\x40\x9F\x96" b"\xE9\x3D\x7E\x11\x73\x93\x17\x2A"
            ),
            "cipher_text": (
                b"\x14\xF7\x64\x61\x87\x81\x7E\xB5" b"\x86\x59\x91\x46\xB8\x2B\xD7\x19"
            ),
        },
        {
            ...
            "cipher_text": (
                b"\xea\xa6\xbd\x25\x88\x0b\xf9\x3d" b"\x3f\x5d\x1e\x4c\xa2\x61\x1d\x91"
            ),
        },
        {
            "algorithm": enums.CryptographicAlgorithm.TRIPLE_DES,
...
def test_encrypt_symmetric(symmetric_parameters):
    ...
    if engine._handle_symmetric_padding.called:
        engine._handle_symmetric_padding.assert_called_once_with(
            engine._symmetric_key_algorithms.get(symmetric_parameters.get("algorithm")),
            symmetric_parameters.get("plain_text"),
            None,
        )
...
def test_encrypt_decrypt_asymmetric(asymmetric_parameters):
    ...
    public_key = public_key_numbers.public_key(backend)
    public_bytes = public_key.public_bytes(
        asymmetric_parameters.get("encoding"), serialization.PublicFormat.PKCS1
    )
    ...
    params=[
        {
            ...
            "padding_method": enums.PaddingMethod.PKCS5,
            "padded_text": (
                b"\x48\x65\x6C\x6C\x6F\x0B\x0B\x0B" b"\x0B\x0B\x0B\x0B\x0B\x0B\x0B\x0B"
            ),
        },
        {
...
@pytest.fixture(
    ...
    params=[
        ...
        },
        {
            ...
            "iteration_count": 4096,
            "derived_data": (
                b"\x56\xfa\x6a\xa7\x55\x48\x09\x9d" b"\xcc\x37\xd7\xf0\x34\x25\xe0\xc3"
            ),
        },
        {
        ...
        },
        {
            ...
            "derivation_length": 42,
            "derivation_data": (b"\xf0\xf1\xf2\xf3\xf4\xf5\xf6\xf7" b"\xf8\xf9"),
            "key_material": (b"\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b" b"\x0b\x0b\x0b"),
            "hash_algorithm": enums.HashingAlgorithm.SHA_1,
            "salt": (b"\x00\x01\x02\x03\x04\x05\x06\x07" b"\x08\x09\x0a\x0b\x0c"),
            "derived_data": (
        ...
        },
        {
            ...
            "derived_data": (
                b"\x90\x01\x50\x98\x3C\xD2\x4F\xB0" b"\xD6\x96\x3F\x7D\x28\xE1\x7F\x72"
            ),
        },
        {
            "derivation_method": enums.DerivationMethod.HASH,
            "derivation_length": 16,
            "derivation_data": (
                b"abcdbcdecdefdefgefghfghighijhijk" b"ijkljklmklmnlmnomnopnopq"
            ),
            "hash_algorithm": enums.HashingAlgorithm.MD5,
            "derived_data": (
                b"\x82\x15\xEF\x07\x96\xA2\x0B\xCA" b"\xAA\xE1\x16\xD3\x87\x6C\x66\x4A"
            ),
        },
        {
            "derivation_method": enums.DerivationMethod.HASH,
        ...
        },
        {
            ...
            "hash_algorithm": enums.HashingAlgorithm.SHA_1,
            "derived_data": (
                b"\x34\xfe\x44\xb0\xd8\xc4\x1b\x93" b"\xf5\xfa\x64\xfb\x96\xf0\x0e\x5b"
            ),
        },
        {
            "derivation_method": enums.DerivationMethod.NIST800_108_C,
            ...
            "hash_algorithm": enums.HashingAlgorithm.SHA_224,
            "derived_data": (
                b"\x0a\xdb\xaa\xb4\x3e\xdd\x53\x2b" b"\x56\x0a\x32\x2c\x84\xac\x54\x0e"
            ),
        },
        {
            "derivation_method": enums.DerivationMethod.NIST800_108_C,
            ...
            "hash_algorithm": enums.HashingAlgorithm.SHA_256,
            "derived_data": (
                b"\x10\x62\x13\x42\xbf\xb0\xfd\x40" b"\x04\x6c\x0e\x29\xf2\xcf\xdb\xf0"
            ),
        },
        {
            "derivation_method": enums.DerivationMethod.NIST800_108_C,
            ...
            "hash_algorithm": enums.HashingAlgorithm.SHA_384,
            "derived_data": (
                b"\xd4\xb1\x44\xbb\x40\xc7\xca\xbe" b"\xd1\x39\x63\xd7\xd4\x31\x8e\x72"
            ),
        },
        {
            "derivation_method": enums.DerivationMethod.NIST800_108_C,
            ...
            "hash_algorithm": enums.HashingAlgorithm.SHA_512,
            "derived_data": (
                b"\xe5\x99\x3b\xf9\xbd\x2a\xa1\xc4" b"\x57\x46\x04\x2e\x12\x59\x81\x55"
            ),
        },
        {
...
SIGN_TEST_DATA = b"\x01\x02\x03\x04\x05\x06\x07\x08" b"\x09\x10\x11\x12\x13\x14\x15\x16"
...
@pytest.fixture(
    ...
    params=[
        {
            "digital_signature_algorithm": enums.DigitalSignatureAlgorithm.MD5_WITH_RSA_ENCRYPTION,
            "crypto_alg": None,
            "hash_algorithm": None,
        ...
        {
            "digital_signature_algorithm": enums.DigitalSignatureAlgorithm.SHA224_WITH_RSA_ENCRYPTION,
            "crypto_alg": None,
            "hash_algorithm": None,
            "padding": enums.PaddingMethod.PSS,
            "key": DER_RSA_KEY,
        ...
        {
            "digital_signature_algorithm": enums.DigitalSignatureAlgorithm.SHA384_WITH_RSA_ENCRYPTION,
            "crypto_alg": None,
            "hash_algorithm": None,
            "padding": enums.PaddingMethod.PSS,
            "key": DER_RSA_KEY,
...
def test_verify_signature(signature_parameters):
    ...
    public_key = public_key_numbers.public_key(backend)
    public_bytes = public_key.public_bytes(
        signature_parameters.get("encoding"), serialization.PublicFormat.PKCS1
    )
