...
app_specific_info_map = sqlalchemy.Table(
    ...
    sqlalchemy.Column(
        "managed_object_id",
        sqlalchemy.Integer,
        sqlalchemy.ForeignKey("managed_objects.uid", ondelete="CASCADE"),
    ),
    sqlalchemy.Column(
        "app_specific_info_id",
        sqlalchemy.Integer,
        sqlalchemy.ForeignKey("app_specific_info.id", ondelete="CASCADE"),
    ),
)
...
object_group_map = sqlalchemy.Table(
    ...
    sqlalchemy.Column(
        "object_group_id",
        sqlalchemy.Integer,
        sqlalchemy.ForeignKey("object_groups.id", ondelete="CASCADE"),
    ),
)
...
class ManagedObject(sql.Base):
    ...
    operation_policy_name = Column(
        "operation_policy_name", String(50), default="default"
    )
...
class CryptographicObject(ManagedObject):
    ...
    unique_identifier = Column(
        "uid", Integer, ForeignKey("managed_objects.uid"), primary_key=True
    )
    cryptographic_usage_masks = Column("cryptographic_usage_mask", sql.UsageMaskType)
    state = Column("state", sql.EnumType(enums.State))
    __mapper_args__ = {"polymorphic_identity": "CryptographicObject"}
    __table_args__ = {"sqlite_autoincrement": True}
...
class Key(CryptographicObject):
    ...
    __tablename__ = "keys"
    unique_identifier = Column(
        "uid", Integer, ForeignKey("crypto_objects.uid"), primary_key=True
    )
    ...
    key_format_type = Column("key_format_type", sql.EnumType(enums.KeyFormatType))

    # Key wrapping data fields
    _kdw_wrapping_method = Column(
        "_kdw_wrapping_method", sql.EnumType(enums.WrappingMethod), default=None
    )
    _kdw_eki_unique_identifier = Column(
        "_kdw_eki_unique_identifier", String, default=None
    )
    ...
    _kdw_eki_cp_padding_method = Column(
        "_kdw_eki_cp_padding_method", sql.EnumType(enums.PaddingMethod), default=None
    )
    ...
    _kdw_eki_cp_key_role_type = Column(
        "_kdw_eki_cp_key_role_type", sql.EnumType(enums.KeyRoleType), default=None
    )
    ...
    _kdw_eki_cp_random_iv = Column("_kdw_eki_cp_random_iv", Boolean, default=None)
    _kdw_eki_cp_iv_length = Column("_kdw_eki_cp_iv_length", Integer, default=None)
    _kdw_eki_cp_tag_length = Column("_kdw_eki_cp_tag_length", Integer, default=None)
    _kdw_eki_cp_fixed_field_length = Column(
        "_kdw_eki_cp_fixed_field_length", Integer, default=None
    )
    _kdw_eki_cp_invocation_field_length = Column(
        "_kdw_eki_cp_invocation_field_length", Integer
    )
    _kdw_eki_cp_counter_length = Column(
        "_kdw_eki_cp_counter_length", Integer, default=None
    )
    _kdw_eki_cp_initial_counter_value = Column(
        "_kdw_eki_cp_initial_counter_value", Integer, default=None
    )
    _kdw_mski_unique_identifier = Column(
        "_kdw_mski_unique_identifier", String, default=None
    )
    ...
    _kdw_mski_cp_padding_method = Column(
        "_kdw_mski_cp_padding_method", sql.EnumType(enums.PaddingMethod), default=None
    )
    ...
    _kdw_mski_cp_key_role_type = Column(
        "_kdw_mski_cp_key_role_type", sql.EnumType(enums.KeyRoleType), default=None
    )
    ...
    _kdw_mski_cp_random_iv = Column("_kdw_mski_cp_random_iv", Boolean, default=None)
    _kdw_mski_cp_iv_length = Column("_kdw_mski_cp_iv_length", Integer, default=None)
    _kdw_mski_cp_tag_length = Column("_kdw_mski_cp_tag_length", Integer, default=None)
    _kdw_mski_cp_fixed_field_length = Column(
        "_kdw_mski_cp_fixed_field_length", Integer, default=None
    )
    _kdw_mski_cp_invocation_field_length = Column(
        "_kdw_mski_cp_invocation_field_length", Integer, default=None
    )
    _kdw_mski_cp_counter_length = Column(
        "_kdw_mski_cp_counter_length", Integer, default=None
    )
    _kdw_mski_cp_initial_counter_value = Column(
        "_kdw_mski_cp_initial_counter_value", Integer, default=None
    )
    _kdw_mac_signature = Column("_kdw_mac_signature", VARBINARY(1024), default=None)
    _kdw_iv_counter_nonce = Column(
        "_kdw_iv_counter_nonce", VARBINARY(1024), default=None
    )
    _kdw_encoding_option = Column(
        "_kdw_encoding_option", sql.EnumType(enums.EncodingOption), default=None
    )
    ...
    def key_wrapping_data(self):
        ...
        encryption_key_info = {
            ...
            "cryptographic_parameters": {
                ...
                "digital_signature_algorithm": self._kdw_eki_cp_digital_signature_algorithm,
                "cryptographic_algorithm": self._kdw_eki_cp_cryptographic_algorithm,
                ...
                "invocation_field_length": self._kdw_eki_cp_invocation_field_length,
                "counter_length": self._kdw_eki_cp_counter_length,
                "initial_counter_value": self._kdw_eki_cp_initial_counter_value,
            },
        }
        ...
        mac_sign_key_info = {
            ...
            "cryptographic_parameters": {
                ...
                "digital_signature_algorithm": self._kdw_mski_cp_digital_signature_algorithm,
                "cryptographic_algorithm": self._kdw_mski_cp_cryptographic_algorithm,
                ...
                "invocation_field_length": self._kdw_mski_cp_invocation_field_length,
                "counter_length": self._kdw_mski_cp_counter_length,
                "initial_counter_value": self._kdw_mski_cp_initial_counter_value,
            },
        }
    ...
    def key_wrapping_data(self, value):
        ...
        self._kdw_eki_cp_digital_signature_algorithm = eki_cp.get(
        ...
        self._kdw_mski_cp_digital_signature_algorithm = mski_cp.get(
            "digital_signature_algorithm"
        )
        self._kdw_mski_cp_cryptographic_algorithm = mski_cp.get(
        ...
        self._kdw_mski_cp_invocation_field_length = mski_cp.get(
...
class SymmetricKey(Key):
    ...
    unique_identifier = Column("uid", Integer, ForeignKey("keys.uid"), primary_key=True)

    __mapper_args__ = {"polymorphic_identity": "SymmetricKey"}
    __table_args__ = {"sqlite_autoincrement": True}
    ...
    def __init__(
        ...
        Args:
            ...
            key_wrapping_data(dict): A dictionary containing key wrapping data
                ...
                Optional, defaults to None.
        """
        super(SymmetricKey, self).__init__(key_wrapping_data=key_wrapping_data)
    ...
    def __repr__(self):
        ...
        key_wrapping_data = "key_wrapping_data={0}".format(self.key_wrapping_data)

        return "SymmetricKey({0}, {1}, {2}, {3})".format(
            algorithm, length, value, key_wrapping_data
        )
...
class PublicKey(Key):
    ...
    def __init__(
        ...
        Args:
            ...
            key_wrapping_data(dict): A dictionary containing key wrapping data
                ...
                Optional, defaults to None.
        """
        super(PublicKey, self).__init__(key_wrapping_data=key_wrapping_data)
    ...
    def validate(self):
        ...
        if not isinstance(self.value, bytes):
            ...
            raise ValueError(
                "key format type must be one of {0}".format(self._valid_formats)
            )
...
event.listen(
    PublicKey._names, "append", sql.attribute_append_factory("name_index"), retval=False
)
...
class PrivateKey(Key):
    ...
    __mapper_args__ = {"polymorphic_identity": "PrivateKey"}
    __table_args__ = {"sqlite_autoincrement": True}
    ...
    def __init__(
        ...
        Args:
            ...
            key_wrapping_data(dict): A dictionary containing key wrapping data
                ...
                Optional, defaults to None.
        """
        super(PrivateKey, self).__init__(key_wrapping_data=key_wrapping_data)
...
class SplitKey(Key):
    ...
    unique_identifier = sqlalchemy.Column(
        "uid", sqlalchemy.Integer, sqlalchemy.ForeignKey("keys.uid"), primary_key=True
    )

    # Split Key object fields
    _split_key_parts = sqlalchemy.Column(
        "_split_key_parts", sqlalchemy.Integer, default=None
    )
    _key_part_identifier = sqlalchemy.Column(
        "_key_part_identifier", sqlalchemy.Integer, default=None
    )
    _split_key_threshold = sqlalchemy.Column(
        "_split_key_threshold", sqlalchemy.Integer, default=None
    )
    _split_key_method = sqlalchemy.Column(
        "_split_key_method", sql.EnumType(enums.SplitKeyMethod), default=None
    )
    _prime_field_size = sqlalchemy.Column(
        "_prime_field_size", sqlalchemy.BigInteger, default=None
    )
    ...
    def __repr__(self):
        ...
        key_part_identifier = "key_part_identifier={0}".format(self.key_part_identifier)
        split_key_threshold = "split_key_threshold={0}".format(self.split_key_threshold)
    ...
    def __eq__(self, other):
        if isinstance(other, SplitKey):
            if self.value != other.value:
                ...
                return False
            elif self.cryptographic_usage_masks != other.cryptographic_usage_masks:
                return False
...
event.listen(
    SplitKey._names, "append", sql.attribute_append_factory("name_index"), retval=False
)
...
class Certificate(CryptographicObject):
    ...
    certificate_type = Column("certificate_type", sql.EnumType(enums.CertificateType))
    ...
    def validate(self):
        ...
        elif not isinstance(self.certificate_type, enums.CertificateType):
            raise TypeError("certificate type must be a CertificateType " "enumeration")
        ...
        for i in range(name_count):
            ...
            if not isinstance(name, six.string_types):
                position = "({0} in list)".format(i)
                raise TypeError(
                    "certificate name {0} must be a string".format(position)
                )
...
class X509Certificate(Certificate):
    ...
    unique_identifier = Column(
        "uid", Integer, ForeignKey("certificates.uid"), primary_key=True
    )

    __mapper_args__ = {"polymorphic_identity": "X509Certificate"}
    __table_args__ = {"sqlite_autoincrement": True}
...
class SecretData(CryptographicObject):
    ...
    __mapper_args__ = {"polymorphic_identity": "SecretData"}
    __table_args__ = {"sqlite_autoincrement": True}

    def __init__(
        self, value, data_type, app_specific_info=None, masks=None, name="Secret Data"
    ):
        """
    ...
    def validate(self):
        ...
        for i in range(name_count):
            ...
            if not isinstance(name, six.string_types):
                position = "({0} in list)".format(i)
                raise TypeError(
                    "secret data name {0} must be a string".format(position)
                )
...
class OpaqueObject(ManagedObject):
    ...
    __mapper_args__ = {"polymorphic_identity": "OpaqueData"}
    __table_args__ = {"sqlite_autoincrement": True}
    ...
    def validate(self):
        ...
        for i in range(name_count):
            ...
            if not isinstance(name, six.string_types):
                position = "({0} in list)".format(i)
                raise TypeError(
                    "opaque data name {0} must be a string".format(position)
                )
...
class ApplicationSpecificInformation(sql.Base):
    ...
    _application_namespace = sqlalchemy.Column(
        "application_namespace", sqlalchemy.String
    )
    _application_data = sqlalchemy.Column("application_data", sqlalchemy.String)
    ...
    def __repr__(self):
        ...
        return "ApplicationSpecificInformation({})".format(
            ", ".join([application_namespace, application_data])
        )
...
class ObjectGroup(sql.Base):
    ...
    id = sqlalchemy.Column(sqlalchemy.Integer, primary_key=True)
    _object_group = sqlalchemy.Column("object_group", sqlalchemy.String, nullable=False)
    managed_objects = sqlalchemy.orm.relationship(
        "ManagedObject", secondary=object_group_map, back_populates="object_groups"
    )
